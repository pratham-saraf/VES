        ...
        if (name && message) {
            ...
            mailOptions = {
                ...
                attachments: [
                    {
                        filename: 'logo.png',
                        path: path.join(process.cwd(), 'components/Email/images','logo.png'),
                        cid: 'logo.png' 
                    },
                    {
                        filename: 'panel.jpg',
                        path: path.join(process.cwd(), 'components/Email/images','panel.jpg'),
                        cid: 'panel.jpg' 
                    },
                    {
                        filename: 'facebook2x.png',
                        path: path.join(process.cwd(), 'components/Email/images','facebook2x.png'),
                        cid: 'facebook2x.png' 
                    },
                    {
                        filename: 'twitter2x.png',
                        path: path.join(process.cwd(), 'components/Email/images','twitter2x.png'),
                        cid: 'twitter2x.png' 
                    },
                    {
                        filename: 'instagram2x.png',
                        path: path.join(process.cwd(), 'components/Email/images','instagram2x.png'),
                        cid: 'instagram2x.png' 
                    },
                    {
                        filename: 'website2x.png',
                        path: path.join(process.cwd(), 'components/Email/images','website2x.png'),
                        cid: 'website2x.png' 
                    }
                ]
